  ...
  return (
    <div className="mt-12">
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl">$43,567.78</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div
          className="bg-white dark:text-gray-200 
        dark:bg-secondary-bg m-3 p-4 rounded-2xl
        md:w-780"
        >
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className="text-3xl font-semiBold">$87,678</span>
                  <span
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semiBold">$37,678</span>
                </p>
